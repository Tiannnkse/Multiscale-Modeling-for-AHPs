...
if __name__ == '__main__':
    ...
    best_params = {
        'learning_rate': 0.2846226165305478,
        'max_depth': 43.92408217566741,
        'min_samples_leaf': 4.13277980222184,
        'min_samples_split': 47.13061880894688,
        'n_estimators': 182.26128435065579,
        'random_state': 9.117396743568985
    }
    ...
    print(f'R2 train:{r2_train}, R2 test: {r2}, RMSE test:{rmse_test}, RMSE train: {rmse_train}')
