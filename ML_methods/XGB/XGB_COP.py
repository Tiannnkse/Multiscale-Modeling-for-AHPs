...
if __name__ == '__main__':
    ...
    param_space.maximize(n_iter=5, init_points=1000)

    best_params = param_space.max['params']

    # best_params with Adsorption Performance
    # best_params = {
    #     'colsample_bytree': 0.46680821121211197,
    #     'gamma': 0.012005787964024947,
    #     'learning_rate': 0.19378067900375998,
    #     'max_depth': 30.636318252234748,
    #     'min_child_weight': 5.892728311404623,
    #     'n_estimators': 157.3327901670027,
    #     'random_state': 43.099415043503136,
    #     'reg_alpha': 0.10970340531599376,
    #     'seed': 893.0217583449215,
    #     'subsample': 0.4858423538030857
    # }
